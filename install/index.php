...
<?php if(empty($backup_db)){?>
        <dl><dt>表前缀：</dt><dd><input name="prefix" type="text" class="int" value="jw_" /></dd><dd class="t">一般无需修改，同数据库安装多个请务必修改</dd></dl>
...
<?php if(count($backup_db)>0){?>
    ...
    <div class="info">
    	<dl><dt>选择数据：</dt><dd><select name="backup_db">
...
<div class="bottom">Powered by <a href="http://wdoyo.com/" target="_blank">DoYo</a>! 2.3 © 2010-2012 /  Templates by <a href="http://www.lala.wang" target="_blank">www.lala.wang</a></div>
</body>
</html>