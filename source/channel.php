...
class channel extends syController
{
	...
	function index(){
		...
		$this->type=syDB('classtype')->find(" molds='".$this->molds."' and tid=".$this->channel['tid']." ",null,'tid,classname,classnamesub,keywords,description,t_content,htmldir,htmlfile,mrank,msubmit');
