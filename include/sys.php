...
require(JWCOM_PATH."/Functions.php");
$GLOBALS['G_DY'] = spConfigReady(require(JWCOM_PATH."/inc.php"),$jwcomConfig);
...
$GLOBALS['skin']=$GLOBALS['WWW'].'skin/'.$jwcomConfig['ext']['view_themes'].'/';
...
$GLOBALS['S']=array('http'=>syExt('http_path'),'title'=>syExt('site_title'),'keywords'=>syExt('site_keywords'),'comtitle'=>syExt('site_comtitle'),'comphone'=>syExt('site_phone'),'comaddress'=>syExt('site_address'),'comemail'=>syExt('site_comemail'),'combeian'=>syExt('site_combeian'),'jwcdnapi'=>syExt('site_jwcdnapi'),'description'=>syExt('site_description'));