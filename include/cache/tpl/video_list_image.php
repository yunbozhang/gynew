  ...
  <div class="tab1 tab1b main">
    ...
    <div class="content">
       ...
       <?php foreach( $lists as $v){ ?>
          <dl><dt><a href="<?php echo $v['url'] ?>" style="<?php echo $v['style'] ?>" target="_blank"><img src="<?php echo $GLOBALS['S']['jwcdnapi'] ?><?php echo $v['litpic'] ?>" /></a></dt><dd><a href="<?php echo $v['url'] ?>" style="<?php echo $v['style'] ?>" target="_blank"><?php echo $v['title'] ?></a></dd></dl>
       <?php } ?>
       </div>
