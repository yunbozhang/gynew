...
<script src="<?php echo $GLOBALS['WWW'] ?>include/js/jwcomupload/swfobject.js" type="text/javascript"></script>
<script type="text/javascript">
function doyocms_upload_config(){
	var multi=false;
	var fileSize=<?php echo $sizeLimit ?>;
	var fileTypeExts='<?php echo $fileExt ?>';
	var bgimage='<?php echo $GLOBALS['WWW'] ?>include/js/jwcomupload/add.gif';
