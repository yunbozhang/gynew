...
return array(
	...
	'sp_core_path' => JWCOM_PATH, 
	'sp_drivers_path' => JWCOM_PATH, 
	'sp_include_path' => array( JWCOM_PATH.'/ext' ),
	...
	'allow_trace_onrelease' => FALSE, 
	'notice_php' => JWCOM_PATH."/notice.php", 
	...
	'sp_cache' => JWCOM_PATH.'/cache/tmp',
	'sp_session' => JWCOM_PATH.'/cache/ses',
	'sp_app_id' => 'sy',
	'controller_path' => APP_PATH.'/source', 
	'model_path' => JWCOM_PATH.'/class', 
	...
	'view' => array( 
		...
		'config' =>array(
			...
			'template_tpl' => JWCOM_PATH.'/cache/tpl',
		),
		'engine_name' => 'templatejwcom', 
		'engine_path' => JWCOM_PATH.'/Template.php', 
	),
